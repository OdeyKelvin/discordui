...
export default function Hero() {
  return (
    <div className=' text-white bg-[#5865f2] overflow-x-clip'>
       ...
       <div className=' relative bottom-[4rem] ml-7 text-black h-[55px] px-10 w-[300px] rounded-[34px] bg-white xl:top-[-4rem] xl:left-[10px] xl:py-2 mt-'>
...
<div className=' relative  ml-8 top-[-2rem] h-[55px] px-10 w-[310px] rounded-[34px] bg-black xl:-top-[7.5rem] xl:left-[340px]'>
     <button className=' mt-4 text-[16px] xl:mb-4 text-white '> 
     Open Discord in your browser</button>
</div>
 

<div className=' relative right-6 bottom-[0.8rem] mr-16 md:mr-[10rem] md:right-[34rem] md:top-[-16rem] '>
