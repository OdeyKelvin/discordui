...
export default function Navbar() {
  ...
  return (
    <div>
      ...
      <div className={!nav? ' z-10 absolute right-0 top-0 w-[60%] rounded-[10px] min-h-screen border-r bg-slate-700 ease-in duration-600 xl:hidden':'fixed left-[100%]'}>
             
             <div className=' '><img className=' relative top-6 ml-6 md:ml-12 lg:ml-16 xl:ml-20' src={discordLogo} alt="discord" /> </div>
             <div onClick={Handlenav} className=' relative bottom-1 ml-[15rem] text-white'> <AiOutlineClose size={23}/></div> 
           <div className=' relative border-b w-[180px] bg-white ml-7 top-10'></div>      
